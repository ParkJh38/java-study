package section06.chap09;
// 날짜와 시간 관련 클래스들
// 예전에는 java.util 패키지의  Date, Calendar를 많이 사용했음
...
public class Main {
    public static void main(String[] args) {
        ...
        //  LocalDateTime 인스턴스는 LocalDate와 LocalTime 인스턴스의 조합으로 만들어짐. 클래스 코드에서 확인 (⭐️of 메소드)
        ...
        today.plusDays(1); // ⭐️기존 인스턴스는 변하지 않음
        ...
        var randomPast = now
                .minusYears(1)  // 사용자가 원하는대로 날짜 조정가능
                .plusMonths(2)
                .minusDays(3)
                .plusHours(4)
                .minusMinutes(5)
        ...
        //----------------------------------------------------------------------------------------------------------------------
        //  ⭐️ 시간 표기형식 지정하기 (시간들을 사용자가 원하는 방식으로 표기하기 위함)
