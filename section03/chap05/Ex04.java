package section03.chap05;
// 타 자료형과 변환
public class Ex04 {
    public static void main(String[] args) {
        //  💡 타 자료형으로부터 문자열로 변환
        String str1 = String.valueOf(true);  // 괄호안의 타 자료형으로 된 부분을 str1에 문자열의 형태로 반환
        ...
        // ⚠️ 런타임 에러 발생. 하나씩 주석해제해서 테스트 (컴파일 단계에서는 오류가 뜨지 않는다. 그래도 논리 오류보다는 낫다)
