...
public class Ex03 {
    public static void main(String[] args) {
        ...
        //----------------------------------------------------------------------------------------------------------
        //  += 연산자:
        //  1. ⭐️ 해당 변수에 문자열을 이어붙임 (부수효과)   ⭐️+=만 된다.(다른 복합대입연산자 -=, *=, /= 이런건 문자열에는 사용 불가)
        String str_c1 = "나는 아무 생각이 없다. ";
        str_c1 += "왜냐하면 ";  // str_c1 = "나는 아무 생각이 없다. 왜냐하면 "

        //  2. 그 결과를 반환
        String str_c2 = str_c1 += "아무 생각이 없기 때문이다.";  // str_c1 = "나는 아무 생각이 없다. 왜냐하면, 아무 생각이 없기 때문이다."
                                                            // str_c2 = str_c1
        boolean bool_c = (str_c1).equals(str_c2);

        //----------------------------------------------------------------------------------------------------------

        //  ⚠️ 상수에는 적용할 수 없음 (final 정의: 상수 선언)
