...
public class Ex07 {
    public static void main(String[] args) {
        ...
        String str_a5 = str_a1.concat(str_a2);  // str_a1 뒤에 str_a2 문자열 이어붙임
        ...
        //  ⭐️ + 연산자와의 차이  (4번째 차이가 중요!!)

        String str_b1 = "ABC";

        //  1. concat은 문자열만 이어붙일 수 있음
        ...
        //  ⚠️ concat은 NullPointerException 발생   // concat은 무조건 문자열의 자료형만 가능하고 null이 아니어야됨
        //String str_c4 = str_c1.concat("ABC");
        //String str_c5 = "ABC".concat(str_c1);

        //  4. ⭐️ 다중 연산시 생성되는 문자열 인스턴스의 수가 다름 (성능적으로는 +가 더 좋음)
        ...
        String str_d2 = new StringBuilder("a")
                ...
                .append("c")
                .append("d")
                .toString(); // "abcd"가 생성됨  // 이전 과정은 암산을 하는 것처럼 메모리에 차지하지 않음
        ...
        String str_d3 = "a"
                ...
                .concat("c") // "abc"가 생성됨
                .concat("d"); // "abcd"가 생성됨
        // "a", "b", "c", "d", "ab", "abc", "abcd"가 생성되어 불필요하게 메모리 차지
    }
}
